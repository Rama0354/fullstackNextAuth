        ...
        <div className='flex flex-col justify-center items-center min-h-screen py-2 gap-3'>
            <div className="relative w-96 p-2 border border-blue-200 rounded-lg">
                <div className="p-2 border-b border-blue-600 mb-3 flex gap-3">
                    <h1 className='font-bold text-3xl text-blue-600'>SignUp</h1>
                    {isLoading ? (
                        <div role="status">
                ...
                <div className="flex flex-col">
                    ...
                    <input className='p-2 border-gray-300 border-2 focus:border-blue-400 outline-none focus:outline-none rounded-md text-gray-700' type="text" name='username' value={user.username} onChange={(e)=>setUser({...user,username:e.target.value})} placeholder='admin' autoComplete='off' />
                </div>
                <div className="flex flex-col">
                ...
                <div className="flex justify-between gap-2 py-2 mt-3">
                    ...
                    <Link href={'/login'} className=' w-1/3 p-2 flex justify-center bg-white hover:bg-gray-200 border-2 border-blue-600 font-medium hover:font-bold text-blue-600 text-lg rounded-md'>Cancel</Link>
                </div>
            </div>
        </div>
    )
